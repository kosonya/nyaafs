...
#
# $Id: hierarchy.py 9 2009-05-20 20:01:00Z Maxim.Kovalev $
...
class hierarchy:
	...
	def __init__(self, name, cursor, base):
		...
		#FIXME Вообще-то, в SQL-запросах LIKE символ _ означает любой (один) символ. Как escape-последовательности делаются в SQLite, я не понял. Эх, надо было Postgres брать...
